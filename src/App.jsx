...
import EntregaEfectivoFausto from './pages/EntregaEfectivoFausto';
...
export default function App() {
  ...
  const [vistaFausto, setVistaFausto] = useState('pedido'); // pedido | efectivo
    ...
    return (
      <div>
        ...
        <div className="cf-nav">
          <button className={vistaFausto === 'pedido' ? 'on' : ''} onClick={() => setVistaFausto('pedido')}>
            🧾 Nuevo pedido
          </button>
          <button className={vistaFausto === 'efectivo' ? 'on' : ''} onClick={() => setVistaFausto('efectivo')}>
            💵 Recibir efectivo
          </button>
        </div>
        <main>
          {vistaFausto === 'pedido' && <ComprasFausto usuario={usuario} />}
          {vistaFausto === 'efectivo' && <EntregaEfectivoFausto usuario={usuario} />}
        </main>
      </div>
    );
  }
  ...
  return (
    <div className={vista === 'vender' ? 'con-panel-fijo' : ''}>
      ...
      <nav className="tabs">
        ...
        {usuario.id === 'nelson' && (
          <button className={vista === 'capital' ? 'on' : ''} onClick={() => setVista('capital')}>
            Capital disponible
          </button>
        )}
        {usuario.id === 'nelson' && (
